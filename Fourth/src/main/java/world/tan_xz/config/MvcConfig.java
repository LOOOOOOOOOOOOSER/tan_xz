...
import world.tan_xz.component.LoginHandlerInterceptor;
...
public class MvcConfig implements WebMvcConfigurer, ErrorPageRegistrar {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        // 添加新的视图控制器
        registry.addViewController("/reward.html").setViewName("reward");
        registry.addViewController("/employment.html").setViewName("employment");
        registry.addViewController("/school_news.html").setViewName("school_news");
        registry.addViewController("/academic_support.html").setViewName("academic_support");
        registry.addViewController("/new_ai.html").setViewName("new_ai");
